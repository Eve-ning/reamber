...
//ouble          COLUMN_CODEtoVALUE  (QTextBrowser *tb, double columnCode, double noOfKeys)
//{
//    double output;
...
//    return output;
//}
//ouble          COLUMN_VALUEtoCODE  (QTextBrowser *tb, double columnValue, double noOfKeys)
//{
//    double output;
...
//    return output;
//}
//ouble          TP_BPMCODEtoVALUE   (QTextBrowser *tb, double TPCode)
//{
//    double output;
//    if (TPCode == 0) {
...
//    return output;
//}
//ouble          TP_BPMVALUEtoCODE   (QTextBrowser *tb, double TPValue)
//{
//    double output;
//    if (TPValue == 0) {
//        STATMSG("Recieved division by 0, returning 100.");
...
//    return output;
//}
//ouble          TP_SVCODEtoVALUE    (QTextBrowser *tb, double TPCode)
//{
//    double output;
//    if (TPCode == 0) {
//        STATMSG("Recieved division by 0, returning -100.");
...
//    return output;
//}
//ouble          TP_SVVALUEtoCODE    (QTextBrowser *tb, double TPValue)
//{
//    double output;
//    if (TPValue == 0) {
//        STATMSG("Recieved division by 0, returning -100.");
...
//List<double>   EHOtoOFFSETLIST     (QTextBrowser *tb, QString EHO)
//{
...
//    return offsetList;
//}
//List<int>      EHOtoCOLUMNLIST     (QTextBrowser *tb, QString EHO)
//{
...
//List<double>   HOtoOFFSETLIST      (QTextBrowser *tb, QStringList HOList)
//{
//    QList<double> offsetList;
//    QString hitObject;
...
//    return offsetList;
//}
//List<int>      HOtoCOLUMNLIST      (QTextBrowser *tb, QStringList HOList, int keyCount)
//{
//    QList<int> columnList;
//    QString hitObject;
...
//    return columnList;
//}
//StringList     HOtoEXTENSIONLIST   (QTextBrowser *tb, QStringList HOList)
//{
...
//List<double>   TPtoOFFSETLIST      (QTextBrowser *tb, QStringList TPList)
//{
//    QList<double> offsetList;
//    QString timingPoint;
...
//    return offsetList;
//}
//List<double>   TPtoCODELIST        (QTextBrowser *tb, QStringList TPList)
//{
...
//List<double>   TPtoSVVALUELIST     (QTextBrowser *tb, QStringList TPList)
//{
...
//    return valueList;
//}
//List<double>   TPtoBPMVALUELIST    (QTextBrowser *tb, QStringList TPList)
//{
//    QList<double> valueList;
//    QString timingPoint;
...
//    return valueList;
//}
//List<double>   TPtoSVCODELIST      (QTextBrowser *tb, QStringList TPList)
//{
//    QList<double> codeList;
//    QString timingPoint;
...
//    return codeList;
//}
//List<double>   TPtoBPMCODELIST     (QTextBrowser *tb, QStringList TPList)
//{
//    QList<double> codeList;
//    QString timingPoint;
...
//StringList OMtoBASIC(QTextBrowser *tb,
//                      bool acceptEHO,
//                      bool acceptHO,
//                      bool acceptTP,
//                      QStringList input,
...
//StringList BASICtoOM(QTextBrowser *tb, QStringList input)
//{
